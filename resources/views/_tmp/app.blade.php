...
<head>
    ...
    <meta name="desk-ui" content="2026-08-12-cities-dropdown">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .desk-cities-ms { min-width:9rem; }
        .desk-cities-ms__dropdown { min-width:16rem; max-height:20rem; }
        .desk-cities-ms__search { width:100%; margin-bottom:6px; border-radius:6px !important; }
        .desk-cities-ms__list { max-height:12rem; overflow:auto; }

...
<head>
    ...
    <meta name="desk-ui" content="2026-08-12-cities-filter">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .desk-cities-filter { padding:12px 14px; margin-bottom:12px; }
        .desk-cities-filter__head {
            display:flex; align-items:center; justify-content:space-between; gap:10px; flex-wrap:wrap;
            margin-bottom:10px;
        }
        .desk-cities-filter__actions { display:flex; gap:6px; flex-wrap:wrap; }
        .desk-cities-chips { display:flex; flex-wrap:wrap; gap:8px; }
        .desk-city-chip {
            display:inline-flex; align-items:center; gap:6px;
            padding:6px 10px; border:1px solid var(--border); border-radius:999px;
            background:#fff; cursor:pointer; font-size:13px; user-select:none;
        }
        .desk-city-chip.is-on {
            border-color:color-mix(in srgb, var(--accent) 55%, var(--border));
            background:color-mix(in srgb, var(--accent) 10%, #fff);
            color:var(--text); font-weight:600;
        }
        .desk-city-chip__input { margin:0; }
        .desk-city-chip__sat {
            font-style:normal; font-size:11px; font-weight:500; color:var(--muted);
            padding:1px 6px; border-radius:999px; background:var(--bg-light);
        }
        .orders-list-top-bar {

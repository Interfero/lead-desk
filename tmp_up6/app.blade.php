...
<head>
    ...
    <meta name="desk-ui" content="2026-08-12-cities-combo-v4">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .desk-cities-picker { padding:12px 14px; margin-bottom:12px; border:1px solid #c4b5fd; background:#faf5ff; }
        .desk-cities-picker__row {
            display:flex; align-items:center; gap:12px; flex-wrap:wrap;
        }
        .desk-cities-picker__label { flex:1; min-width:12rem; }
        .desk-cities-combo { position:relative; min-width:18rem; }
        ...
        .desk-cities-combo__panel {
            position:absolute; z-index:40; top:calc(100% + 4px); left:0; right:0; min-width:20rem;

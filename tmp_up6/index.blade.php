...
@endif
<p class="muted" style="font-size:11px;margin:0 0 8px;" id="desk-ui-build">desk-ui: cities-combo-v4</p>
...
function selectAllCities(){
    document.querySelectorAll('#desk-cities-ms-list input[type=checkbox]').forEach(c=>{ c.checked=true; });
    updateCitiesMs();
}
function deselectAllCities(){
    document.querySelectorAll('#desk-cities-ms-list input[type=checkbox]').forEach(c=>{ c.checked=false; });
    updateCitiesMs();
}
(function(){

...
<head>
    ...
    <meta name="desk-ui" content="2026-08-12-cities-picker-top">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .desk-cities-picker { padding:12px 14px; margin-bottom:12px; }
        .desk-cities-picker__row {
            display:flex; align-items:center; gap:12px; flex-wrap:wrap;
        }
        .desk-cities-picker__label { flex:1; min-width:12rem; }
        .desk-cities-ms { min-width:14rem; }
        .desk-cities-ms .multiselect-selected {
            border-radius:8px; min-height:2.25rem; padding:0.45rem 0.75rem;
        }
        .desk-cities-ms .multiselect-text { color:var(--text); font-weight:600; }
        .desk-cities-ms__dropdown { min-width:18rem; max-height:none; overflow:visible; }
        .desk-cities-ms__search { width:100%; margin-bottom:6px; border-radius:6px !important; }
        .desk-cities-ms__list { max-height:14rem; overflow:auto; }
        .desk-cities-ms__list label { display:flex; align-items:center; gap:6px; }
        .desk-cities-ms__empty { padding:8px 6px; font-size:12px; }
        .desk-city-chip__sat {
